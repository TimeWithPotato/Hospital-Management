                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            <li class="nav-item">
                                <a class="nav-link" href="http://localhost/Hospital-Management/user/doctor.php">Profile
                                </a>
                            </li>
                            <li class="nav-item">
        ...
        <section>
            <div class="container">
                <div class="row gx-5 gy-5">
                    <div id="doc-view-cardiology" class="card col me-3" style="width: 18rem;">
                    ...
                    <div id="doc-view-dermatology" class="card col me-3" style="width: 18rem;">
                    ...
                    <div id="doc-view-neurology" class="card col" style="width: 18rem;">
