...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($result->num_rows == 0) {
        ...
        window.location.href = 'http://localhost/Hospital-Management/user/ins_med_test.php';
        </script>";
        exit();
    }
    ...
    <main style="margin-top:10vh">
        <section class="container">
            ...
            <form action="ins_med_test.php" class="form-floating mb-3" method="POST">
                ...
                <div class="form-floating mb-3">
                    <input type="hidden" class="form-control" id="floatingInput" name="doc_id" required value="<?php echo htmlspecialchars($doc_id) ?>">
