        ...
        <section>
            <div class="container">
                <div class="row gx-5 gy-5">
                    <div id="pat-view-cardiology" class="card col me-3" style="width: 18rem;">
                    ...
                    <div id="pat-view-dermatology" class="card col me-3" style="width: 18rem;">
                    ...
                    <div id="pat-view-neurology" class="card col" style="width: 18rem;">
